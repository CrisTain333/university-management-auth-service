...
const createAcademicSemester = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicSemester_service_1.AcademicSemesterService.createAcademicSemester(academicSemesterData);
    // Send Response
...
const getAllSemesters = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicSemester_service_1.AcademicSemesterService.getAllSemestersFromDb(paginationOptions, filters);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
exports.AcademySemesterController = {
