...
const handleValidationError_1 = __importDefault(
    require('../error/handleValidationError')
);
const config_1 = __importDefault(require('../config'));
const ApiError_1 = __importDefault(require('../error/ApiError'));
const zod_1 = require('zod');
const zodErrorHandler_1 = __importDefault(
    require('../error/zodErrorHandler')
);
// import { errorLogger } from '../shared/logger';
const handleCastError_1 = __importDefault(
    require('../error/handleCastError')
);
const globalErrorHandler = (error, req, res, next) => {
    ...
    if (
        ...
        const simplifiedError = (0, handleValidationError_1.default)(
            error
        );
