...
const createDepartment = catchAsync(
    async (req: Request, res: Response) => {
        ...
        const result =
            await AcademicDepartmentService.createDepartment(
...
const getAllDepartments = catchAsync(
    async (req: Request, res: Response) => {
        ...
        const result =
            await AcademicDepartmentService.getAllDepartments(
                filters,
                paginationOptions
            );
...
const getSingleDepartment = catchAsync(
    async (req: Request, res: Response) => {
        const { id } = req.params;
        const result =
            await AcademicDepartmentService.getSingleDepartment(id);
...
const updateDepartment = catchAsync(
    async (req: Request, res: Response) => {
        const { id } = req.params;
        const result =
            await AcademicDepartmentService.updateDepartment(
                id,
                req.body
            );
